...
{
    public class OverfishingChangeControllerService
    {
        public List<PenguinData> GetOverfishingAlteredData()
        {
            ...
            List<PenguinData> filteredData = AlterDataOverfishingChange(bulkData);

            return filteredData;
        }

        public List<PenguinData> AlterDataOverfishingChange(List<PenguinData> bulkData)
        {
            ...
            var filteredData = bulkData
                ...
                .Select(p => new PenguinData
                {
                    ...
                    Year = p.Year,
                    PenguinCount = (int)Math.Round(p.PenguinCount * 1.15) // Increase by 15%
                })
                .ToList();
